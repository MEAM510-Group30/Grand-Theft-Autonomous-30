...
<html>
  ...
  <body>
    ...
    <div style="text-align: center">
      <button
        id="trophy_moving_mode_button"
        class="button"
        onclick="activateModeButtons('trophy_moving_mode_button')"
      >
        Trophy Moving
      </button>
      <button
        id="fully_manual_mode_button"
        class="button"
        onclick="activateModeButtons('fully_manual_mode_button')"
      >
        Fully Manual
      </button>
    </div>
    <div style="text-align: center">
      <button
        id="wall_following_mode_button"
        class="button"
        onclick="activateModeButtons('wall_following_mode_button')"
      >
        Wall Following
      </button>
      <button
        id="car_pushing_mode_button"
        class="button"
        onclick="activateModeButtons('car_pushing_mode_button')"
      >
        Car Pushing
      </button>
