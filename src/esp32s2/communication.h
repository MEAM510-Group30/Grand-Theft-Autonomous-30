...
class esp_now {    // remember to initialize; use member function sendMessage() to send group number
...
public:
  ...
  void initialize(){
    ...
    if (esp_now_init() != ESP_OK) {
      ...
      ESP.restart();
    } else Serial.println("init succeed");
    ...
    } else Serial.println("Pair succeed");
